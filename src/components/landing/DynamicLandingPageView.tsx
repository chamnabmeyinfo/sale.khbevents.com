  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#070D0A] text-slate-900 dark:text-gray-100 flex flex-col selection:bg-amber-400 selection:text-black transition-colors">
      ...
      <main className="flex-1">
        <section className="relative overflow-hidden pt-12 pb-20 lg:pt-16 lg:pb-28 border-b border-slate-200 dark:border-emerald-900/30">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-7 space-y-6">
                {page.badge && (
                  <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-500/15 border border-amber-400/40 text-amber-700 dark:text-amber-300 text-xs font-bold uppercase tracking-wider">
                ...
                {(page.eventDate || page.venue) && (
                  <div className="flex flex-wrap gap-4 pt-2 text-xs text-emerald-800 dark:text-emerald-200">
                    {page.eventDate && (
        ...
        {page.highlights && page.highlights.length > 0 && (
          <section className="py-20 bg-white dark:bg-[#08130E] transition-colors">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {page.highlights.map((h, i) => (
                  <div
                    key={h.id || i}
                    className="rounded-2xl bg-slate-50 dark:bg-[#0B1A12] border border-slate-200 dark:border-emerald-900/50 p-6 space-y-3 hover:border-emerald-500/40 transition-colors shadow-sm"
                  >
                    <div className="w-10 h-10 rounded-xl bg-white dark:bg-emerald-950 border border-slate-200 dark:border-emerald-800/60 flex items-center justify-center text-amber-500 dark:text-amber-400 font-bold shadow-sm">
                      0{i + 1}
                    </div>
        ...
        {page.packages && page.packages.length > 0 && (
          <section id="packages" className="py-20 bg-slate-50 dark:bg-[#060B08] relative transition-colors">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center max-w-2xl mx-auto mb-14 space-y-3">
                <span className="text-xs font-bold uppercase tracking-widest text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800/40 px-3 py-1 rounded-full shadow-sm">
        ...
        {page.gallery && page.gallery.length > 0 && (
          <section className="py-20 bg-white dark:bg-[#08120D] border-t border-slate-200 dark:border-emerald-900/30 transition-colors">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {page.testimonials && page.testimonials.length > 0 && (
          <section className="py-20 bg-slate-50 dark:bg-[#060D09] transition-colors">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="space-y-6">
                {page.testimonials.map((t, i) => (
                  <div
                    key={t.id || i}
                    className="rounded-2xl bg-white dark:bg-[#0A1811] border border-slate-200 dark:border-emerald-900/40 p-6 sm:p-8 space-y-4 shadow-sm"
                  >
