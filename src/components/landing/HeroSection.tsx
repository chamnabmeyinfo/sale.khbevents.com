      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-950/80 border border-emerald-700/50 shadow-inner">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight leading-[1.15]">
              Engineering <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-emerald-300 to-amber-300">Unforgettable</span> Experiences That Command Attention.
            </h1>
            ...
            <div className="grid sm:grid-cols-2 gap-3 pt-2 text-sm text-gray-200 max-w-xl mx-auto lg:mx-0 text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
              ...
              <a
                href="#estimator"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-4 rounded-xl font-semibold text-sm text-emerald-200 bg-[#0c1f16] hover:bg-[#132c21] border border-emerald-700/50 transition-all"
              >
            ...
            <div className="grid grid-cols-3 gap-4 pt-6 border-t border-emerald-900/40">
              <div>
                ...
                <div className="text-xs text-gray-400 uppercase tracking-wider mt-0.5">Successful Events</div>
              </div>
              <div>
                <div className="text-2xl sm:text-3xl font-black text-amber-400">250K+</div>
                <div className="text-xs text-gray-400 uppercase tracking-wider mt-0.5">Attendees Managed</div>
              </div>
              <div>
                <div className="text-2xl sm:text-3xl font-black text-emerald-400">99.4%</div>
                <div className="text-xs text-gray-400 uppercase tracking-wider mt-0.5">Client Satisfaction</div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5">
            <div className="relative rounded-3xl p-1 bg-gradient-to-b from-emerald-500/30 via-emerald-800/20 to-transparent shadow-2xl">
              <div className="relative rounded-[22px] overflow-hidden bg-[#0A1610] border border-emerald-800/40 p-5 space-y-5">
                ...
                <div className="bg-emerald-950/60 rounded-xl p-4 border border-emerald-800/40 space-y-2">
                  <div className="flex items-center justify-between text-xs font-bold text-emerald-300">
                    <span>UPCOMING HIGH-LEVEL CAMPAIGNS</span>
                    <span className="text-amber-400 animate-pulse">● ACTIVE NOW</span>
                  </div>
