...
function LeadFormInner({
  ...
  if (submitted) {
    return (
      <div id="inquiry-form" className="py-16 scroll-mt-20">
        <div className="max-w-2xl mx-auto rounded-3xl bg-[#0B1A13] border border-emerald-500/60 p-8 sm:p-12 text-center space-y-6 shadow-2xl">
          ...
          <div className="p-4 rounded-xl bg-emerald-950/80 border border-emerald-800/50 text-xs text-gray-300 space-y-1 text-left">
            <div><strong className="text-white">Client:</strong> {formData.fullName}</div>
            <div><strong className="text-white">Phone / Telegram:</strong> {formData.phone}</div>
            <div><strong className="text-white">Event Type:</strong> {formData.eventType}</div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
            <a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs uppercase tracking-wider transition-all"
            >
            ...
            <button
              ...
              className="w-full sm:w-auto px-5 py-3 rounded-xl text-xs text-gray-400 hover:text-white transition-colors cursor-pointer"
            >
  ...
  return (
    <section id="inquiry-form" className="py-20 bg-[#060C09] relative scroll-mt-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl bg-gradient-to-b from-[#0F2218] via-[#0B1912] to-[#08130E] border border-emerald-700/40 p-6 sm:p-12 shadow-2xl relative overflow-hidden">
          <div className="absolute -top-20 -right-20 w-60 h-60 bg-amber-500/10 rounded-full blur-3xl pointer-events-none" />

          <div className="text-center space-y-3 mb-10">
            <span className="text-xs font-bold uppercase tracking-widest text-amber-400 bg-amber-950/60 border border-amber-800/40 px-3 py-1 rounded-full inline-flex items-center gap-1.5">
          ...
          {errorMessage && (
            <div className="mb-6 p-4 rounded-xl bg-rose-950/80 border border-rose-800/60 text-xs text-rose-200">
              {errorMessage}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="grid sm:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-[#07130D] border border-emerald-900/60 text-white placeholder-gray-500 text-sm focus:outline-none focus:border-amber-400 transition-colors"
                />
              </div>

              <div>
                <label className="block text-xs font-semibold text-gray-200 mb-1.5">
                  Phone / Telegram / WhatsApp <span className="text-amber-400">*</span>
                </label>
                <input
                  type="tel"
                  required
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-[#07130D] border border-emerald-900/60 text-white text-sm focus:outline-none focus:border-amber-400 transition-colors"
                >
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-xl bg-[#07130D] border border-emerald-900/60 text-white placeholder-gray-500 text-sm focus:outline-none focus:border-amber-400 transition-colors resize-none"
              />
            </div>
