...
import { campaigns } from './dict/campaigns';
...
const parts: Dictionary[] = [common, nav, login, dashboard, pages, leads, settings, roundRobin, ads, guide, editor, editorExtras, auth, builder, media, popupAnalytics, campaigns];
